...
1. **Билинейная пара** 
    ...
    $Q_1, Q_2$ – публичные параметры из этапа настройки (Этап подготовки), которые необходимы для проверки.

    Это проверка того, что сгенерированное доказательство действительно соответствует вычислениям, которые были проведены для входных данных $x$.
